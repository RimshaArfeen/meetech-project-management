...
const ProfilePage = () => {
     ...
     return (
          <div className="min-h-screen bg-bg-page p-page-x py-page-y animate-in fade-in slide-in-from-bottom-2 duration-700">
                         ...
                         <div className="relative flex flex-col md:flex-row items-center md:items-end gap-6 mt-4">
                              ...
                              <div className="flex-1 text-center md:text-left space-y-2">
                                   <div className="flex flex-col md:flex-row md:items-center gap-3">
                                        <h1 className="text-headline-lg font-black text-text-primary tracking-tight">
                                             {user.name}
                                        </h1>
